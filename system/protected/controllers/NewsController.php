...
class NewsController extends AccessController {
    ...
    public function actionAddpage() {
        ...
        if (isset($_POST['News'])) {
            ...
            if (isset($_POST['News']['open_datetime']) && $_POST['News']['open_datetime'])
                $model->open_datetime = $_POST['News']['open_datetime'];
    ...
    public function actionPage() {
        ...
        if(isset($_POST['Teacher'])) {
            $id = $_POST['Teacher']['id'];
            $teacher_id = $_POST['Teacher']['teacher_id'];
            $news = $this->loadModel($id);
            $news->notPage = false;
            $news->teacher_id = $teacher_id;
