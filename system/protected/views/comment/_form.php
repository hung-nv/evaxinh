        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <?php if (isset($model->oldAvatar) && $model->oldAvatar): ?>
                    <div style="margin-top:10px;"><img src="../uploads/comment/<?php echo $model->oldAvatar; ?>" width="80px" /></div>
                <?php endif; ?>
            </div>
            
            <div class="form-group">
                <?php echo $form->labelEx($model, 'content'); ?>
                <?php echo $form->textArea($model, 'content', array('rows' => 5,'id' => 'editor1','class' => 'form-control', 'required' => 'required')); ?>
                <div class="help-block with-errors"></div>
            </div>
